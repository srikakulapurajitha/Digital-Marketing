...
urlpatterns = [
    ...
    path('fetch_camps/', views.fetch_camps, name='fetch_camps'),
    path('fetch_dependent_options/', views.fetch_dependent_options, name='fetch_dependent_options'),
    ...
    path('clientform/',views.upload_image,name='clientform'),  #client data
